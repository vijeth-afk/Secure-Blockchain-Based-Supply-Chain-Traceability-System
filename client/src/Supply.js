...
function Supply() {
  ...
  const editable = canEdit('supply', role);
  ...
  return (
    <div>
      ...
      <form onSubmit={handlerSubmitRMSsupply}>
        ...
        <div className="alert alert-secondary">You have read-only access to the supply steps.</div>
      )}
      <hr />
      <br />
      <h5>
      ...
      <form onSubmit={handlerSubmitManufacturing}>
        ...
        <div className="alert alert-secondary">You have read-only access to manufacturing steps.</div>
      )}
      <hr />
      <br />
      <h5>
      ...
      <form onSubmit={handlerSubmitDistribute}>
        ...
        <div className="alert alert-secondary">You have read-only access to distribution steps.</div>
      )}
      <hr />
      <br />
      <h5>
      ...
      <form onSubmit={handlerSubmitRetail}>
        ...
        <div className="alert alert-secondary">You have read-only access to retail steps.</div>
      )}
      <hr />
      <br />
      <h5>
      ...
      <form onSubmit={handlerSubmitSold}>
        ...
        <div className="alert alert-secondary">You have read-only access to mark items sold.</div>
      )}
      <hr />
    </div>
  );
